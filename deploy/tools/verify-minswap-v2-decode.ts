 ...
 * real mainnet datums — lives in the `optivaults-reference` operator repo,
 * alongside the rest of the Preprod E2E test infrastructure. Operators
 * wishing to reproduce that verification should adapt the byte-for-byte
 * structural test against their own copy of a recent Minswap V2 mainnet
 * order datum.
 */
