...
V1 在 mainnet 啟動時設定 100,000 USDCx 的營運上限，直到第三方審計完成。整個專案的定位是 Cardano DeFi 公共財參考實作——歡迎 fork、特化、商業化使用，也歡迎在 GitHub Issues 或 [Discord](https://discord.gg/4VZK6vdK4t) 提出對抗性檢視。
